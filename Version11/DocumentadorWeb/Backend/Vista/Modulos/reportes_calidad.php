<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    <h6 class="card-title">Reporte Calidad</h6>

    
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#calidad" wi>
                                        GENERAR REPORTE
</button>
...
<div class="modal fade" id="calidad" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">REPORTE CALIDAD</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
    
    
                                <form action="Controlador/Reportes/reporteCalidad.php" method="post">
